...
namespace DuplicantStatusBar.Config
{
    ...
    public sealed class StatusBarOptions : SingletonOptions<StatusBarOptions>, IOptions
    {
        ...
        [Option("STRINGS.DUPLICANTSTATUSBAR.OPTIONS.SHOWSKILLPOINTBADGES.NAME", "STRINGS.DUPLICANTSTATUSBAR.OPTIONS.SHOWSKILLPOINTBADGES.DESC", "STRINGS.DUPLICANTSTATUSBAR.OPTIONS.CATEGORIES.APPEARANCE")]
        [JsonProperty]
        public bool ShowSkillPointBadges { get; set; } = true;

        [Option("STRINGS.DUPLICANTSTATUSBAR.OPTIONS.SHOWSKILLPOINTSTOOLTIP.NAME", "STRINGS.DUPLICANTSTATUSBAR.OPTIONS.SHOWSKILLPOINTSTOOLTIP.DESC", "STRINGS.DUPLICANTSTATUSBAR.OPTIONS.CATEGORIES.APPEARANCE")]
        [JsonProperty]
        public bool ShowSkillPointsInTooltip { get; set; } = true;
