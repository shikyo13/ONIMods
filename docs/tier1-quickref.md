...
| DuplicantStatusBar | `Core/DuplicantStatusBarMod.cs` | v2.10.0 - persistent dupe status HUD, skill point badges, stamina tooltip, bionic support, extensibility API |
