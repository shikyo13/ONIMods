# Tier 3 - Late-Game Lag Spike Investigation (Full Data)
...
| Section | Heading |
|-|-|
| Recording catalogue | `## Recording Catalogue` |
| Hypotheses tested | `## Hypotheses Tested` |
| Offset bug details | `## The One-Frame Offset Bug` |
| GCBudget analysis | `## What GCBudget Actually Achieved` |
| Experiment protocol | `## Experiment Protocol` |
| Experiment results | `## Experiment Results` |
| Multiple spike sources | `## Multiple Spike Sources` |
| Bug fix verification (rec 19) | `## Recording 20260308_084928` |
